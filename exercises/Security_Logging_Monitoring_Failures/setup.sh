...
cd /home/ubuntu/HackBerryBox/exercises/Security_Logging_Monitoring_Failures
...
echo "Security Logging and Monitoring Failures exercise setup complete. Access it at http://localhost:8091"
